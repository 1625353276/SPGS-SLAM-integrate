...
void MapPoint::ComputeDistinctiveDescriptors()
{
    ...
    for(size_t i=0;i<N;i++)
    {
        ...
        {
            // Use SPmatcher::DescriptorDistance_sp for SuperPoint float descriptors
            float distij = SPmatcher::DescriptorDistance_sp(vDescriptors[i],vDescriptors[j]);
