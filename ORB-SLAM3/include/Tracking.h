...
public:
    ...
    Sophus::SE3f GrabImageRGBD(const cv::Mat &imRGB,const cv::Mat &imD, const double &timestamp, string filename, const cv::Mat &undistorted_img);
    Sophus::SE3f GrabImageMonocular(const cv::Mat &im, const double &timestamp, string filename, const cv::Mat &undistorted_img);
